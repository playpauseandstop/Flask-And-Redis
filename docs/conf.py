# -*- coding: utf-8 -*-
#
# Flask-And-Redis documentation build configuration file, created by
# sphinx-quickstart on Mon Aug  4 13:55:44 2014.
#
...
ORIGINAL_VERSION = re.findall("__version__ = '([^']+)'", INIT_PY)[0]

VERSION = ORIGINAL_VERSION.split('-')[0]
RELEASE = ORIGINAL_VERSION

sys.path.append(rel('..'))
sys.path.append(rel('docs', '_themes'))
...
html_theme_options = {
    'index_logo': False,
    'github_fork': 'playpauseandstop/Flask-And-Redis',
}
...
htmlhelp_basename = 'Flask-And-Redisdoc'
